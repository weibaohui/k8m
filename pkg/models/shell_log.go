...
type ShellLog struct {
	...
	UserName      string    `gorm:"size:255;index:idx_shell_log_username" json:"username,omitempty"`
	Cluster       string    `gorm:"size:100;index:idx_shell_log_cluster" json:"cluster,omitempty"`
	Namespace     string    `gorm:"size:100;index:idx_shell_log_namespace" json:"namespace,omitempty"`
	PodName       string    `gorm:"size:255;index:idx_shell_log_pod_name" json:"pod_name,omitempty"`
