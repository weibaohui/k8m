...
type ClusterUserRole struct {
	...
	Cluster             string                             `gorm:"size:100;index:idx_cluster" json:"cluster,omitempty"`           // 集群名称
	Username            string                             `gorm:"size:255;index:idx_username" json:"username,omitempty"`         // 用户名
	Role                string                             `gorm:"size:50;index:idx_role" json:"role,omitempty"`                  // 角色类型：只读、读写、Exec
