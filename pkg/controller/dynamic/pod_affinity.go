...
func getPodAffinityTerms(kind string, item *unstructured.Unstructured, action string, rule podAffinity) ([]any, error) {
...
// 生成动态的 patch 数据
func generateRequiredPodAffinityDynamicPatch(kind string, terms []any) (map[string]any, error) {
	// 打印rules
