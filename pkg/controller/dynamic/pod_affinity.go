...
func RegisterAffinityRoutes(api *gin.RouterGroup) {
	ctrl := &AffinityController{}
...
func (ac *AffinityController) ListPodAffinity(c *gin.Context) {
	name := c.Param("name")
	ns := c.Param("ns")
	group := c.Param("group")
	kind := c.Param("kind")
...
func (ac *AffinityController) AddPodAffinity(c *gin.Context) {
	processPodAffinity(c, "add")
}
func (ac *AffinityController) UpdatePodAffinity(c *gin.Context) {
	processPodAffinity(c, "modify")
}
func (ac *AffinityController) DeletePodAffinity(c *gin.Context) {
