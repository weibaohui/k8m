...
type MCPToolLog struct {
	...
	ToolName    string    `gorm:"size:255;index:idx_tool_name" json:"tool_name,omitempty"`
	ServerName  string    `gorm:"size:255;index:idx_server_name" json:"server_name,omitempty"`
	...
	CreatedBy   string    `gorm:"size:255;index:idx_created_by" json:"created_by,omitempty"`
}
