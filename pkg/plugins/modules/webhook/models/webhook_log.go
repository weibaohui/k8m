...
type WebhookLogRecord struct {
	...
	WebhookID    uint      `gorm:"index:idx_webhook_id" json:"webhook_id,omitempty"` // webhook接收器ID
	...
	Success      bool      `gorm:"index:idx_success" json:"success,omitempty"`       // 是否成功
	...
	RequestTime  time.Time `gorm:"index:idx_request_time" json:"request_time,omitempty"` // 请求时间
