...
import WebSocketMarkdownViewer from "@/components/Amis/custom/WebSocketMarkdownViewer.tsx";
...
// @ts-ignore
registerRenderer({type: 'webSocketMarkdownViewer', component: WebSocketMarkdownViewer})
// 注册过滤器
